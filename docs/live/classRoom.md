...
您可以下载我们的 SDK 使用简单的代码实现直播课堂的效果，包括语音、视频、课件播放等上课方式。让我们以创建一场简单的直播课堂开始吧。

引导页效果图-电脑端

![image-20201202103718453](..\img\image-20201202103718453.png)

引导页效果图-移动端

<img src="..\img\image-20201202111257982.png" alt="image-20201202111257982" style="width:50%;margin-left:25%;" />
