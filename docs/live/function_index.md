...
|             |             | [获取账号或频道转播列表信息](channelOperate?id=_23、获取账号或频道转播列表信息) |             | 
|             |             | [设置频道最大在线人数](channelOperate?id=_24、设置频道最大在线人数) |             | 
|             |             | [查询频道广告列表](channelOperate?id=_25、查询频道广告列表) |             | 
|             |             | [修改直播推流方式](channelOperate?id=_26、修改直播推流方式) |             | 
|             |             | [删除硬盘推流的视频](channelOperate?id=_27、删除硬盘推流的视频) |             | 
|             | ▼直播状态      |                                            |      |
...
| ▼Web观看页  |                |                                            |      |
|             | ▼快捷设置      |                                            |      |
|             |             | [上传图片资源](webSetting?id=_1、上传图片资源) |             | 
|             | ▼页面信息      |                                            |      |
...
|             |             | [设置授权观看类型](webAuth?id=_7、设置授权观看类型) |             | 
|             |             | [更新白名单](webAuth?id=_8、更新白名单) |             | 
|             |             | [删除白名单](webAuth?id=_9、删除白名单) |             | 
|             |             | [查询频道或全局登记观看字段](webAuth?id=_10、查询频道或全局登记观看字段) |             | 
|             |             | [查询页面登记观看列表](webAuth?id=_11、查询页面登记观看列表) |             | 
|             |             | [下载频道登记观看记录](webAuth?id=_12、下载频道登记观看记录) |             | 
|             |             | [新增白名单](webAuth?id=_13、新增白名单) |             | 
|             |             | [下载频道观看白名单列表](webAuth?id=_14、下载频道观看白名单列表) |             | 
|             | ▼页面菜单      |                                            |      |
