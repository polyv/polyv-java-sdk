...
| goods | false | Array | 道具打赏【详见[ChannelGood参数描述](webInteract.md?id=polyv67)】 | 
| requestId | true | String | 每次请求的业务流水号，便于客户端/服务器端排查问题 | 

<h6 id="polyv67"><a href="#/channelOperate?id=polyv67"data-id="ChannelGood参数描述"class="anchor"><span>ChannelGood参数描述</span></a></h6> <!-- {docsify-ignore} -->
...
| goodPrice | true | Double | 道具打赏价格【详见[Double参数描述](webInteract.md?id=polyv68)】 | 
...
| -- | -- | -- | -- | 
| channelId | false | String | 频道号，不传为全局设置 | 
| cashes | true | Array | 请求体参数，现金打赏数额数组，数组的长度必须为6【详见[Double参数描述](webInteract.md?id=polyv69)】 | 
| cashMin | true | Double | 请求体参数，现金打赏自定义最小金额【详见[Double参数描述](webInteract.md?id=polyv70)】 | 
...
| cashes | true | Array | 请求体参数，现金打赏数额数组，数组的长度必须为6【详见[Double参数描述](webInteract.md?id=polyv71)】 | 
| cashMin | true | Double | 请求体参数，现金打赏自定义最小金额【详见[Double参数描述](webInteract.md?id=polyv72)】 | 
| goods | true | Array | 道具打赏【详见[ChannelGood参数描述](webInteract.md?id=polyv73)】 | 

<h6 id="polyv73"><a href="#/channelOperate?id=polyv73"data-id="ChannelGood参数描述"class="anchor"><span>ChannelGood参数描述</span></a></h6> <!-- {docsify-ignore} -->

| 参数名 | 必选 | 类型 | 说明 | 
| -- | -- | -- | -- | 
| goodName | true | String | 道具名称，不能超过5个字符 | 
| goodImg | true | String | 道具图片，不能超过120个字符（通过上传图片接口上传获取图片地址，或者使用默认地址;鲜花：01-flower.png;咖啡:02-coffee.png;点赞:03-good.png;掌声:04-applaud.png;666:05-666.png;小星星:06-star.png;钻石:07-diamond.png;跑车:08-car.png;火箭:09-rocket.png;前缀统一为：//livestatic.videocc.net/uploaded/images/webapp/channel/donate/） | 
| goodPrice | true | Double | 道具打赏价格【详见[Double参数描述](webInteract.md?id=polyv74)】 | 
| goodEnabled | true | String | 道具开关，值为 Y/N , Y为开启 | 
