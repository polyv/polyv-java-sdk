...
| globalEnabledType | true | String | 功能类型，具体选项见：LiveConstant.GlobalEnabledType | 
...
| file | true | Array | 图片文件列表，支持同时上传不超过6个【详见[File参数描述](webSetting.md?id=polyv73)】 | 
| requestId | true | String | 每次请求的业务流水号，便于客户端/服务器端排查问题 | 
