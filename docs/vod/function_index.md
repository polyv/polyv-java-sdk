...
|           | ▼视频进度条打点      |                                            |      |
|             |             | [查询单个视频的打点信息](videoPogressBarManagement?id=_1、查询单个视频的打点信息) |             | 
|             |             | [设置视频打点](videoPogressBarManagement?id=_2、设置视频打点) |             | 
...
|           | ▼视频字幕      |                                            |      |
|             |             | [查询视频字幕](subtitleService?id=_1、查询视频字幕) |             | 
...
|             |             | [查询视频广告列表](advertisingService?id=_3、查询视频广告列表) |             | 
