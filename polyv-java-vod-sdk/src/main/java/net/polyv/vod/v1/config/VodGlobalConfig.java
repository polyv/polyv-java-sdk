...
//    }
     ...
     */
    public static void  init(String userId,String appId,String secretKey){
...
//        VodGlobalConfig.READ_TOKEN=readToken;
     ...
     */
    public static void  init(String userId,String appId,String secretKey,Integer timeOut ,Integer maxClientNum){
        VodGlobalConfig.USER_ID = userId;
        VodGlobalConfig.APP_ID = appId;
//        VodGlobalConfig.WRITE_TOKEN = writeToken;
//        VodGlobalConfig.READ_TOKEN=readToken;
