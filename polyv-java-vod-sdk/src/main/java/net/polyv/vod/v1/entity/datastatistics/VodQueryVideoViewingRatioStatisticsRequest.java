...
@ApiModel("查询视频的观看比例统计数据请求实体")
public class VodQueryVideoViewingRatioStatisticsRequest extends VodCommonRequest {
    
    /**
     * 视频ID，不填为查询用户维度
     */
    @ApiModelProperty(name = "videoId", value = "视频ID，不填为查询用户维度", required = false)
    @JSONField(name = "vid")
